import {
  ...
  const BaiDoc = () => {
    ...
    const NoiDung = () => (
      <View>
        <View>
          <Text style={styles.title}>{baidocData.title}</Text>
        </View>
        <View style={styles.baiDocContainer}>
          <Text style={styles.baiDoc}>{baidocData.content}</Text>
        </View>
        {showBaiDich && (
          <View style={styles.baiDocContainer}>
            <Text style={styles.subContent}>{baidocData.subcontent}</Text>
          </View>
        )}
      </View>
    );
